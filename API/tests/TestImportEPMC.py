...
class TestImportEPMC(unittest.TestCase):
    ...
    def test_new_year_import(self):
        ...
        return new year date in ImportEPMC and
...
#         locale.setlocale(category, locale)
    ...
    def test_wrong_amount_in_import_all_data(self):
        """
        TODO FINISH!
        Nedd to use a mock who will replace def ImportEPMC.__get_number_of_pages with wrong number of pages and catch ValueError
